...
main :-
    ...
    adicionarFilmePorParametros('Interestelar', ['Ficção científica', 'Drama'], 'Um grupo de astronautas viaja através de um buraco de minhoca em busca de um novo planeta para habitar.', 'Christopher Nolan', ['Matthew McConaughey', 'Anne Hathaway', 'Jessica Chastain'], 2014, 169, 8.6, 8.5),
    ...
    adicionarFilmePorParametros('O Senhor dos Anéis: A Sociedade do Anel', ['Aventura', 'Fantasia'], 'Um grupo de heróis se une para destruir um poderoso anel e salvar a Terra Média.', 'Peter Jackson', ['Elijah Wood', 'Ian McKellen', 'Viggo Mortensen'], 2001, 178, 8.8, 8.7).
    adicionarFilmePorParametros('A Origem', ['Ação', 'Ficção científica'], 'Um grupo de ladrões especializados invade os sonhos das pessoas para extrair informações valiosas.', 'Christopher Nolan', ['Leonardo DiCaprio', 'Joseph Gordon-Levitt', 'Elliot Page'], 2010, 148, 8.8, 8.7),
    adicionarFilmePorParametros('Pulp Fiction: Tempo de Violência', ['Crime', 'Drama'], 'Histórias interligadas retratando o submundo do crime em Los Angeles.', 'Quentin Tarantino', ['John Travolta', 'Samuel L. Jackson', 'Uma Thurman'], 1994, 154, 8.9, 8.8),
    adicionarFilmePorParametros('Clube da Luta', ['Drama'], 'Um homem descontente cria um clube de luta clandestino como forma de escape da sua vida monótona.', 'David Fincher', ['Brad Pitt', 'Edward Norton', 'Helena Bonham Carter'], 1999, 139, 8.8, 8.7),
